...
public class Signin_Enabler extends AppCompatActivity {

    EditText edit_EmailAddress, edit_Password;
    TextView text_ForGotPassword,text_Message;
    Button btn_Submit;

    String str_name,str_email,str_mobile,str_id;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate (savedInstanceState);
        setContentView (R.layout.activity_signin_enabler);
        ...
        text_ForGotPassword.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent ( Signin_Enabler.this,Enabler_ForgotPassword_Activity.class );
    ...
    public void userLogin(String email, String password) {
        ...
        ProgressDialog dialog = new ProgressDialog (Signin_Enabler.this);
        dialog.setMessage ("Verify...");
        dialog.show ( );

        StringRequest request = new StringRequest (Request.Method.POST, URLS.Login_enabler, new Response.Listener<String> ( ) {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(user.equals ("Login successful")){

                        Toast.makeText (Signin_Enabler.this, user, Toast.LENGTH_SHORT).show ( );

                        JSONObject jsonObject1 = new JSONObject ( details );

                        str_id = jsonObject1.getString ("id");
                        str_name = jsonObject1.getString ("enabler_name");
                        str_email = jsonObject1.getString ("enabler_email");
                        str_mobile = jsonObject1.getString ("phone");
                        ...
                        SharedPrefManager.getInstance (Signin_Enabler.this).userLogin (login_modelClass);

                        text_Message.setTextColor (Color.GREEN);
                        text_Message.setText ("Emailid & Password Valid");

                        Intent intent = new Intent(Signin_Enabler.this, Navigation_Activity.class);
                        startActivity (intent);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                text_Message.setText ("Email id & Password is not Valid");
        ...
        RequestQueue requestQueue = Volley.newRequestQueue (Signin_Enabler.this);
